...
public class GamePanel extends JPanel implements ActionListener, KeyListener{
    ...
    private int delay1 = 250;
    private int delay2 = 450;
    private int speed = 1;
    ...
    public void paint(Graphics g) {
        ...
        if (moves == 0) {
            ...
            g.drawString("Select Difficulty Level", 150, 300);
            
            g.setFont(new Font("Arial", Font.PLAIN, 20));
            g.drawString("Press 1 for Easy", 350, 350);
            g.drawString("Press 2 for Medium", 350, 380);
            g.drawString("Press 3 for Hard", 350, 410);
        } else {
